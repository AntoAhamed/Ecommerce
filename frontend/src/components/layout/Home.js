...
export default function Home() {
    ...
    return (
        <>
            {isLoading ? <Loader /> :
                <div>
                    <div className='bg-orange-600 h-lvh text-white flex flex-col justify-center items-center rounded-br-full rounded-tr-full mr-32 hover:mr-16 transition-all hover:transition-all shadow-xl'>
                        <h1 className='lg:text-6xl md:text-5xl sm:text-4xl font-bold mb-6 lg:hover:text-8xl hover:text-6xl transition-all hover:transition-all'>Welcome To Ecommerce</h1>
